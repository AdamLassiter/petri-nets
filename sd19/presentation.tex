...
\begin{document}
    ...
    \frame{
        ...
        \begin{itemize}
            \item Sequents are a pair of terms, maintained by deduction rules
    ...
    \frame{
        ...
        \begin{itemize}
            \item Fast (quadratic polynomial time and space)
            \item Can extract a sequent proof
    ...
    \frame{
        ...
        Transitions and corresponding sequent rules:
        \[
            \begin{array}{ccc}
                \begin{tikzpicture}[matrix]
                    \foreach \i/\a in {1/{}, 2/A, 3/{}}
    ...
    \frame{
        ...
        \end{prooftree}
        \begin{itemize}
            \item Required for Coalescence to be equivalent to CL proof search
            \item Does not work for \emph{multiplicative} rules, see \citet{contraction-restrictions}
        \end{itemize}
    }
    ...
    \frame{
        ...
        \[
            \begin{array}{ccc}
                \begin{tikzpicture}[matrix]
                    \foreach \i/\a in {1/{}, 2/\Gamma, 3/{}}
                        {\draw[gray] (\i,0) node[src] {$\a$} (\i,.7) -- (\i,3.3);}
                    \foreach \j/\b in {1/A, 2/\vee, 3/B}
                        {\draw[gray] (0,\j) node[tgt] {$\b$} (.7,\j) -- (3.3,\j);}
                    \node[tokG] (a) at (2,1) {};
                    \node[tokG] (c) at (2,2) {};
                    \draw[jmp1] (a) to (c);
                ...
                \begin{tikzpicture}[matrix]
                  \foreach \i/\a in {1/{}, 2/\Gamma, 3/{}}
                    {\draw[gray] (\i,0) node[src] {$\a$} (\i,.7) -- (\i,3.3);}
                  \foreach \j/\b in {1/A, 2/\wedge, 3/B}
                    {\draw[gray] (0,\j) node[tgt] {$\b$} (.7,\j) -- (3.3,\j);}
                  \node[tokG] (a) at (2,1) {};
                  \node[tokG] (b) at (2,3) {};
                  \node[tokG] (c) at (2,2) {};
        ...
        \]
        \begin{itemize}
            \item $w$/$c$ equivalent to increasing/decreasing dimension by one
        \end{itemize}
    }
    ...
    \frame{
        ...
        \begin{itemize}
            \item No longer quadratically bounded
