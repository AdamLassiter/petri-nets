\chapter{Conclusion}
    ...
    % Your conclusion should summarise the points made in the argument and provide a synthesis of thought on the main thesis.
    ...
    % A conclusion can also open out onto areas which have been bracketed in the main body for reasons of length.
    % For instance, in a dissertation devoted to criticising a body of work, the conclusion could suggest what other bodies of work might be more appropriate, or how you might want to reformulate the field in line with your findings.
