\section{Classical Logic}
    ...
    \begin{corollary*}[Derivation Equivalence]
        ...
        %% TODO: See Jean-Yves Girard, `morally' identical
    \end{corollary*}

    \begin{example}
        Considering the leaves $\vdash A, A$ and $\vdash B$ with the conclusion $\vdash A \wedge B$, the following proofs are weakly equivalent:
        \begin{prooftree}
            \AxiomC{$\vdash A, A$}
        ...
        Further, equivalence of sequents may be applied, in particular equivalence up to commutativity of formulae $\vdash A, B \equiv \,\, \vdash B, A$.
    \end{example}
